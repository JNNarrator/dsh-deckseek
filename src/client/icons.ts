...
export {
   ...
   */
  IconGoalOutlineRegular as GoalGlyph,
  IconPaperPlaneOutlineRegular as AgentGlyph,
  IconBranchOutlineRegular as BranchGlyph,
  IconGlobeOutlineRegular as GlobeGlyph,
  IconAlarmClockOutlineRegular as ScheduleGlyph,
  IconQueueOutlineRegular as QueueGlyph,
  IconCordisPluginOutlineRegular as PluginGlyph,
  IconContextInjectionOutlineRegular as TriggerGlyph,
  /** Generic tool family, and the fallback for any unclassified call. */
  IconSparkleRegular as ToolGlyph,
  /** The author of a user turn. */
  IconUserOutlineRegular as UserGlyph,
} from '@deepseek-ai/dsh-client-ui-primitives';
 ...
 */
export const ACTIVITY_GLYPHS: Record<ToolCategory, ComponentType<{ className?: string }>> = {
