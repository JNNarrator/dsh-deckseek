...
export function MotionPlainText({ text, enabled, revision }) {
    ...
    return _jsx(WordScope.Provider, { value: scope, children: _jsxs("div", { className: css.reasonPlain, children: [live && _jsx("span", { className: css.srOnly, children: text }), _jsx("span", { "aria-hidden": live || undefined, children: live
