...
export class WordTimeline {
    ...
    begin(source, enabled, revision, now) {
        ...
        // Live means this buffer has words with birth times to spend. A buffer that
        // mounted with text already in it (opening a long conversation) has none,
        // and saying otherwise painted a word-by-word reveal over history.
    ...
    words(value, offset) {
        ...
        //
        // Text the reader has already received stays one inert leaf: segmenting it
        // again would mint a React component per historical word on every render of
        // an open conversation. Only the appended suffix needs word identities.
