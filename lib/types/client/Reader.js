...
function GroupStatus({ group, sessionId, useChat, useSessionPendingInteraction, motion, variant }) {
    ...
    if (variant === 'dock') {
        if (kind !== 'delving')
            return null;
        return _jsx("div", { className: css.statusDock, "data-reader-status-dock": true, children: _jsx(StatusText, { text: text, motion: motion, shimmer: true }) });
    }
    if (kind === 'delving')
        return null;
