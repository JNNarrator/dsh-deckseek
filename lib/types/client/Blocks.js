...
export function CopyAnswer({ blocks }) {
    ...
    if (!text.trim())
        return null;
    return _jsxs("div", { className: css.answerActions, children: [_jsx("button", { type: "button", className: css.iconButton, "aria-label": ui('copy.answer'), title: ui('copy.answer'), onClick: async () => {
