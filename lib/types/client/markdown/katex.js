 ...
 */
export function renderTexToReact(value, displayMode) {
    let html;
    try {
        ...
        try {
            ...
            /* v8 ignore next 8 */
            return (_jsx("span", { className: "katex-error", style: { color: 'var(--dsw-alias-text-danger, #cc0000)' }, title: String(error), children: value }));
        }
    }
